...
# disk
#change according to your personal path locations
win32:HOME = C:
BOOSTPATH = $$(HOME)/Boost/boost_1_57_0
CONFIG+=c++11
win32:CONFIG -= embed_manifest_exe

CONFIG(release, debug|release) {
    win32:NGLLIB=$$HOME/NGL/lib/NGL
    DEFINES += NDEBUG
    BUILDCFG=release
} else {
    DEFINES += _DEBUG
    win32:NGLLIB=$$HOME/NGL/lib/NGLD
    BUILDCFG=debug
}
